...
public class Constants {
   ...
   */
  public static final String GET_MAPPING_RESOURCE_USERS = "${api.uri.domain.context.resource.users}";

  /**
   * Constante que contiene el nombre del recurso.
   */
  public static final String API_RESOURCES_NAME_USERS_CREATE = "create-users";
  
  /**
   * Constante que contiene el nombre del recurso.
   */
  public static final String API_RESOURCES_NAME_USERS_FIND = "find-users";
  
  /**
   * Constante que contiene el valor del uri mapping.
   */
  public static final String GET_MAPPING_RESOURCE_PRODUCTS = "${api.uri.domain.context.resource.products}";

  /**
   * Constante que contiene el nombre del recurso.
   */
  public static final String API_RESOURCES_NAME_PRODUCT_CREATE = "create-products";
  
  /**
   * Constante que contiene el nombre del recurso.
   */
  public static final String API_RESOURCES_NAME_PRODUCT_FIND = "find-products";
  
  /**
   * Constante que contiene el valor del uri mapping.
   */
  public static final String GET_MAPPING_RESOURCE_ORDERS = "${api.uri.domain.context.resource.orders}";

  /**
   * Constante que contiene el nombre del recurso.
   */
  public static final String API_RESOURCES_NAME_ORDER_CREATE = "create-orders";
  
  /**
   * Constante que contiene el valor del uri mapping.
   */
  public static final String GET_MAPPING_RESOURCE_REPORTS = "${api.uri.domain.context.resource.reports}";

  /**
   * Constante que contiene el nombre del recurso.
   */
  public static final String API_RESOURCES_NAME_REPORTS_CREATE = "create-reports";
